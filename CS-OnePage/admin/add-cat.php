                                ...
                                <div class="col-md-8">
                                    <div class="form">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="control-group">
                                                <div class="form-group mb-4">
                                                    <input type="text" class="form-control form-control-lg" placeholder="Class" name="class" required />
                                        ...
                                        if (isset($_POST['submit']))
                                        {
                                            ...
                                            $editSql = mysqli_query($db, "INSERT INTO `cat`(`title`, `class`) VALUES ('$title', '$class')");
                                            if ($editSql) {
