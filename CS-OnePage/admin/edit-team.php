        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <?php
                    $sql = mysqli_query($db, "SELECT * FROM team WHERE id = '".$_GET['edit']."'");
                                ...
                                <div class="col-md-8">
                                    <div class="form">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="control-group">
                                                <div class="form-group mb-4">
                                                    <input type="text" value="<?php echo $row['name']; ?>" class="form-control form-control-lg" placeholder="Name" name="name" required />

                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <div class="form-group mb-4">
                                                    <input type="text" value="<?php echo $row['role']; ?>" class="form-control form-control-lg" placeholder="Role" name="role" required />
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <div class="form-group mb-4">
                                        ...
                                        if (isset($_POST['submit']))
                                        {
                                            ...
                                            if (empty($img))
                                            {
                                                $editSql = mysqli_query($db, "UPDATE `team` SET `name`='$name',`role`='$role' WHERE id = '".$_GET['edit']."'");
                                                if ($editSql) {
                                                    echo "<script>alert('Team Has Been Updated!')</script>";
                                                ...
                                                $editSql = mysqli_query($db, "UPDATE `team` SET `name`='$name',`role`='$role',`img`='$img' WHERE id = '".$_GET['edit']."'");
                                                if ($editSql) {
