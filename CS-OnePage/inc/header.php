...
<header id="top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-white fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="#top"><?php echo $rowSite['site_name']; ?></a>
    ...
    <section class="wt-section hero-large hero mt-md-5">
        <div class="hero-img bg-overlay" data-overlay="0" style="background-image: url(<?php echo $rowSite['site_main_img']; ?>);"></div>
        <div class="container">
            <div class="row align-items-center text-white">
                <div class=" col-md-6">
                    <!-- heading -->
                    <h1 class="text-uppercase mb-3 display-3 font-weight-bolder" data-aos="fade-right">
                        <?php echo $rowSite['site_main_heading']; ?>
                    </h1>
                    <a class="btn btn-lg btn-outline-light py-2 mt-3 px-4 btn-pill" data-aos="fade-left" href="#price">Our Price</a>
                </div>
            </div>
        </div>
    </section>
